...
import { Landing, Header } from '@cubitrix/cubitrix-react-ui-module'
...
export default function Home() {
  ...
  const becomeMemberData = {
    ...
    link: 'http://complend.shopgeorgia.ge/create-account',
  }
  ...
  const allImages = {
    ...
    whyComplend: {
      bottom: '/img/dashboard/whyComplend-bottom.svg',
    },
  }
